...
-- Generado a partir del modelo JPA (Hibernate ddl-auto=create sobre PostgreSQL 16).
...
-- Name: idx_rankings_mode_score; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_rankings_mode_score ON public.rankings USING btree (mode, score DESC);
